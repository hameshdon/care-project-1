  ...
  return (
    <>
      ...
      <div className="readmore-tech_2">
        <h1 className="tech-head">Online Payments UPI, Debit Card Transactions</h1>
        <p className="tech-content">
          {" "}
          Payment in Size Corner has become more and more simple. The buyer can make <br />  
          payments through online payments such as UPI, Debit card transactions, and credit<br />  
           card transactions. The merchant has many options for accepting payments which<br />  
            makes it easy for them to choose what works best for them.
